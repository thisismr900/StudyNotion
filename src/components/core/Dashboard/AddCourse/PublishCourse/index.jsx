...
export const PublishCourse = () => {
  ...
  const handlePublishCourse = async () => {
    ...
    (course?.status === COURSE_STATUS.DRAFT && getValues("public") === false) ){
      //form didn't update -> dont make api calls
      goToCourses();
      console.log("No form updation")
      return;
    }
    //form data is updated
    const formData = new FormData();
    console.log("formData created ,in handlePublishCourse", formData);
  ...
  return (
    <div className='text- rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6'>
